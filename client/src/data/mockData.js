...
export const budgetData = {
  ...
  duration: 14,
  travelers: 2,
  totalEstimated: 416000,
  targetBudget: 400000,
  overBudget: 16000,
  averageDaily: 29714,
  targetDaily: 28571,
  categories: [
    { name: 'Flights', amount: 104000, color: '#2563EB' },
    { name: 'Accommodation', amount: 145600, color: '#94a3b8' },
    { name: 'Meals', amount: 104000, color: '#ec4899' },
    { name: 'Activities', amount: 62400, color: '#f97316' },
  ],
  dailySpending: [
    { day: 1, actual: 14400, label: 'Day 1' },
    { day: 2, actual: 17600, label: '' },
    { day: 3, actual: 24000, label: '' },
    { day: 4, actual: 38400, label: 'Day 4 (Venice)' },
    { day: 5, actual: 28000, label: '' },
    { day: 6, actual: 30400, label: '' },
    { day: 7, actual: 25600, label: 'Day 7' },
    { day: 8, actual: 23200, label: '' },
    { day: 9, actual: 24800, label: '' },
    { day: 10, actual: 27200, label: 'Day 10' },
    { day: 11, actual: 22400, label: '' },
    { day: 12, actual: 20800, label: '' },
    { day: 13, actual: 24000, label: '' },
    { day: 14, actual: 23200, label: 'Day 14' },
  ],
  alerts: [
    {
      type: 'over-budget',
      ...
      detail: 'Gondola ride and dinner at St. Mark\'s Square significantly exceeded the daily allocation of ₹28,571.',
  ...
  topExpenses: [
    { name: 'Roundtrip Airfare (DEL to FCO)', detail: 'Air India · Sep 1', amount: 104000, icon: 'plane' },
    { name: 'Hotel Danieli Venice (3 Nights)', detail: 'Accommodation · Oct 4-7', amount: 68000, icon: 'hotel' },
    { name: 'Dinner at Quadri', detail: 'Meals · Unplanned Expense', amount: 25600, icon: 'utensils' },
  ],
};
...
export const adminStats = {
  ...
  avgBudget: { value: '₹3,40,000', change: '+18.5%', trend: 'up' },
